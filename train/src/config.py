...
class Arguments(TrainingArguments):
    ...
    project_dir: str = field(
        default='/home/u20238046/workspace_lwh/project/demorank', metadata={"help": "Path of demorank project"}
    )
    data_dir: str = field(
    ...
    train_data_shards_file: Optional[str] = field(
        default=None, metadata={"help": "The raw train data file generated by LLM"}
    )
    uni_dataset: bool = field(default=False, metadata={"help": "whether to use msmarco+beir to train"})
    uni_dataset_path: Optional[str] = field(
        default='', metadata={"help": "the dir of msmarco+beir training data"}
    )
    ...
    full_contrastive_loss: bool = field(default=False, metadata={"help": "use full contrastive loss or not"})
    in_batch: bool = field(default=False, metadata={"help": "whether to use in-batch negatives"})
    ...
    kshot_training: bool = field(default=False, metadata={"help": "whether to use kshot training data (varying context input)"})
    ...
    do_stable_kd: bool = field(default=False, metadata={"help": "whether use pt's loss"})
    ...
    max_test_samples: Optional[int] = field(default=100000, metadata={"help": "max examples for test"})
    ...
    reward_max_length: int = field(default=512, metadata={"help": "max length for reward model inputs, i.e., current input + demonstration"})
    ...
    train_device: str = field(default='cuda:1', metadata={"help": "the device to use"})
    monobert_path: str = field(default='../../../../llm/monobert-large-msmarco', metadata={"help": ""})
